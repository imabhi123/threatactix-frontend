...
import { Shield, Globe, History, Bell, Layout, DollarSign } from "lucide-react";
    ...
    <div className="min-h-screen w-full bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <div className="relative min-h-[90vh] flex items-center">
        <div className="px-4 sm:px-6 lg:px-8 py-24">
          <div className="relative z-10">
            <h1 className="text-5xl font-bold text-blue-500 dark:text-blue-400 mb-6">
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-20">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-400 mb-12">
          ...
          <span className="text-red-500">webhook</span>, and{" "}
          <span className="text-blue-500">Microsoft teams</span> to receive
          real-time alerts.
        </p>
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-20">
        ...
        <p className="text-purple-500 dark:text-purple-400 mb-12">
          THREATACTIX BLOG
        </p>
